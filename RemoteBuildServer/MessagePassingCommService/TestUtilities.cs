    ...
    public class TestUtilities
    {
        ...
        public static void checkResult(bool result, string compName)
        {
            if (!ClientEnvironment.verbose)
                return;
            if (result)
                Console.WriteLine(" -- {0} test passed", compName);
            else
                Console.WriteLine(" -- {0} test failed", compName);
        }
        ...
        {
            Console.WriteLine("  {0}", msg);
            Console.WriteLine(" {0}", new string(ch, msg.Length + 2));
        }
        ...
        #if (TEST_TEST_UTILITIES)
        static void Main(string[] args)
        {
            TestUtilities.vbtitle("Testing TestUtilities! ");
